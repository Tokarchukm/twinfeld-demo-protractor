const enterIntoSearch = require('../lib/helper').enterIntoSearch
const getLinkFromSearchResultNum = require('../lib/helper').getLinkFromSearchResultNum
const proceedToSearchResultNum = require('../lib/helper').proceedToSearchResultNum
